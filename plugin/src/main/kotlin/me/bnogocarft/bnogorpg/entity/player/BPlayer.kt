...
abstract class BPlayer(open val playerName: String) {
    var isStunned = false
    ...
    fun saveStats() {
        ...
        BnogoSQL.con.prepareStatement(
            "UPDATE players SET \"playTime\" = '$playTime', " +
                    ...
                    "'${spellsTmp[7]?.codeName}||${spellsTmp[7]?.rank}'] WHERE name = '$playerName';"
        ).execute()
    }
}