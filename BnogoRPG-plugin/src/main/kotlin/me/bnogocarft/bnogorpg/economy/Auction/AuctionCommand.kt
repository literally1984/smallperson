                    ...
                    for (i in 0..9) {
                        ...
                        sender.sendMessage(
                            "${ChatColor.BOLD}${auc.ID}: " +
                                    ...
                                    "${floor(floor(auc.endTimeUnix / 86400.0))}D, " +
                                    "${floor(floor(auc.endTimeUnix / 3600.0))}H, " +
                                    "${floor(floor(auc.endTimeUnix / 60.0))}M, " +
                                    "${floor(auc.endTimeUnix.toDouble())}S"
                        )
                    }
                    return true
                }
