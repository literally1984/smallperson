(function (root, factory) {
  ...
  var addSuppressed = kotlin_kotlin.$_$.gd;
  ...
  HandlerRegistration.prototype.a30 = function () {
    return this.z2z_1;
  };
  ...
  function Events() {
    this.b30_1 = new CopyOnWriteHashMap();
  }
  Events.prototype.c30 = function (definition, value) {
    var exception = null;
    var tmp0_safe_receiver = this.b30_1.i2(definition);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlinx.coroutines.internal.LinkedListHead.forEach' call
      var cur = tmp0_safe_receiver.r1k_1;
      while (!equals(cur, tmp0_safe_receiver)) {
        if (cur instanceof HandlerRegistration) {
          // Inline function 'io.ktor.events.Events.raise.<anonymous>' call
          var tmp0__anonymous__q1qw7t = cur;
          try {
            var tmp = tmp0__anonymous__q1qw7t.z2z_1;
