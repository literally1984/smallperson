(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['react-dom/client'] === 'undefined') {
      throw new Error("Error loading module 'Bnogorpg-site'. Its dependency 'react-dom/client' was not found. Please, check whether 'react-dom/client' is loaded prior to 'Bnogorpg-site'.");
    }
    if (typeof react === 'undefined') {
      throw new Error("Error loading module 'Bnogorpg-site'. Its dependency 'react' was not found. Please, check whether 'react' is loaded prior to 'Bnogorpg-site'.");
    }
    if (typeof this['@emotion/css'] === 'undefined') {
      throw new Error("Error loading module 'Bnogorpg-site'. Its dependency '@emotion/css' was not found. Please, check whether '@emotion/css' is loaded prior to 'Bnogorpg-site'.");
    }
    if (typeof this['kotlin-kotlin-stdlib-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'Bnogorpg-site'. Its dependency 'kotlin-kotlin-stdlib-js-ir' was not found. Please, check whether 'kotlin-kotlin-stdlib-js-ir' is loaded prior to 'Bnogorpg-site'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'Bnogorpg-site'. Its dependency 'kotlin-wrappers-kotlin-react-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-js-ir' is loaded prior to 'Bnogorpg-site'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-dom-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'Bnogorpg-site'. Its dependency 'kotlin-wrappers-kotlin-react-dom-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-dom-js-ir' is loaded prior to 'Bnogorpg-site'.");
    }
    root['Bnogorpg-site'] = factory(typeof this['Bnogorpg-site'] === 'undefined' ? {} : this['Bnogorpg-site'], this['react-dom/client'], react, this['@emotion/css'], this['kotlin-kotlin-stdlib-js-ir'], this['kotlin-wrappers-kotlin-react-js-ir'], this['kotlin-wrappers-kotlin-react-dom-js-ir']);
  }
  ...
  function Welcome$lambda($this$FC, props) {
    ...
    tmp$ret$2 = tmp$ret$1;
    var tmp = tmp$ret$2;
    $this$FC.y(tmp, Welcome$lambda$lambda(name$delegate));
    var tmp$ret$5;
    ...
    tmp$ret$5 = tmp$ret$4;
    var tmp_0 = tmp$ret$5;
    $this$FC.y(tmp_0, Welcome$lambda$lambda_0(name$delegate));
    return Unit_getInstance();
  }
  ...
  function Welcome$lambda$lambda($name$delegate) {
    return function ($this$invoke) {
      ...
      $this$invoke.x('Hello, ' + invoke$lambda($name$delegate));
      return Unit_getInstance();
    };
  }
...
//# sourceMappingURL=Bnogorpg-site.js.map
