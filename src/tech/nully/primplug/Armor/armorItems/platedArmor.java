...
public class platedArmor {
    ...
    private static void createPlatedHelm() {
        ...
        Helmlore.add("");
        a.addAttributes(PlatedHelm, 0, 6, 15, 5);
        Helmlore.add("");
        Helmlore.add(ChatColor.YELLOW + "" + ChatColor.BOLD + "PASSIVE SET BONUS: Flexible but hard");
        Helmlore.add(ChatColor.GRAY + "Being made out of Iron plates instead of ");
        Helmlore.add(ChatColor.GRAY + "ingots, wearing this armor in a set will");
        ...
        Helmlore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "nature of Plated lazui...");
        Helmlore.add("");
    ...
    private static void createPlatedChes() {
        ...
        Cheslore.add("");
        a.addAttributes(PlatedChes, 1, 18, 25, 10);
        Cheslore.add("");
        ...
        Cheslore.add(ChatColor.GRAY + "power of the Plated lazui used to craft it");
        Cheslore.add("");
        Cheslore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "Armor made from Plated Lazui granting");
        ...
        Cheslore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "nature of Plated lazui...");
        Cheslore.add("");
    ...
    private static void createPlatedLeg() {
        ...
        Leglore.add("");
        a.addAttributes(PlatedLeg, 1, 14, 20, 7);
        Leglore.add("");
        ...
        Leglore.add(ChatColor.GRAY + "power of the Plated lazui used to craft it");
        Leglore.add("");
        Leglore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "Armor made from Plated Lazui granting");
        ...
        Leglore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "nature of Plated lazui...");
        Leglore.add("");
    ...
    private static void createPlatedBoots() {
        ...
        Bootslore.add(ChatColor.GRAY + "power of the Plated lazui used to craft it");
        Bootslore.add("");
        Bootslore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "Armor made from Plated Lazui granting");
        ...
        Bootslore.add(ChatColor.GRAY + "" + ChatColor.ITALIC + "nature of Plated lazui...");
        Bootslore.add("");
