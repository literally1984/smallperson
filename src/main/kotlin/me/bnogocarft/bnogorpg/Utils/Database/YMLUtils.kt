...
class YMLUtils {
    companion object {
        ...
        @Deprecated(
            "Already exists in PPlayer",
            ReplaceWith("PPlayer.playerConfig", "tech.nully.primplug.recode.Utils.PItems.PPlayer")
        )
        ...
        fun saveCustomYml(
            ymlConfig: FileConfiguration,
            ymlFile: File?
        ) { // Creates the player's file, do not touch only to be used in the PlayerJoinEvent
            try {
