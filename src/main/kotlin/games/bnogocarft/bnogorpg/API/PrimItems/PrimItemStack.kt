...
data class PrimItem (val item: ItemStack) {
    ...
    var rarity: _root_ide_package_.games.bnogocarft.bnogorpg.API.Items.Rarity.Rarity? = null;
    ...
    init {
        ...
        level = Level.toInt()
        rarity = _root_ide_package_.games.bnogocarft.bnogorpg.API.Items.Rarity.Rarity(
        ...
        for (s in item.itemMeta.lore) {
            ...
            for (ench in _root_ide_package_.games.bnogocarft.bnogorpg.enchantStuff.enchantMechanic.getEnchants()) {
                if (s.contains(ench)) {
                    enchants!!.add(ench)
                }
            }
    ...
    companion object {
        ...
        private val b = _root_ide_package_.games.bnogocarft.bnogorpg.Armor.baseAdder()
