(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof this['react-dom/client'] === 'undefined') {
      throw new Error("Error loading module 'BnogoSite'. Its dependency 'react-dom/client' was not found. Please, check whether 'react-dom/client' is loaded prior to 'BnogoSite'.");
    }
    if (typeof react === 'undefined') {
      throw new Error("Error loading module 'BnogoSite'. Its dependency 'react' was not found. Please, check whether 'react' is loaded prior to 'BnogoSite'.");
    }
    if (typeof this['@emotion/css'] === 'undefined') {
      throw new Error("Error loading module 'BnogoSite'. Its dependency '@emotion/css' was not found. Please, check whether '@emotion/css' is loaded prior to 'BnogoSite'.");
    }
    if (typeof this['kotlin-kotlin-stdlib-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'BnogoSite'. Its dependency 'kotlin-kotlin-stdlib-js-ir' was not found. Please, check whether 'kotlin-kotlin-stdlib-js-ir' is loaded prior to 'BnogoSite'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'BnogoSite'. Its dependency 'kotlin-wrappers-kotlin-react-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-js-ir' is loaded prior to 'BnogoSite'.");
    }
    if (typeof this['kotlin-wrappers-kotlin-react-dom-js-ir'] === 'undefined') {
      throw new Error("Error loading module 'BnogoSite'. Its dependency 'kotlin-wrappers-kotlin-react-dom-js-ir' was not found. Please, check whether 'kotlin-wrappers-kotlin-react-dom-js-ir' is loaded prior to 'BnogoSite'.");
    }
    root.BnogoSite = factory(typeof BnogoSite === 'undefined' ? {} : BnogoSite, this['react-dom/client'], react, this['@emotion/css'], this['kotlin-kotlin-stdlib-js-ir'], this['kotlin-wrappers-kotlin-react-js-ir'], this['kotlin-wrappers-kotlin-react-dom-js-ir']);
  }
...
//# sourceMappingURL=BnogoSite.js.map
